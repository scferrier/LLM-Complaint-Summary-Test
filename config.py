...
MODEL_API_KEYS = {"claude-opus": "ANTHROPIC_API_KEY", "gpt-5.2": "OPENAI_API_KEY", "gemini": "GEMINI_API_KEY", "perplexity": "PERPLEXITY_API_KEY", "grok": "XAI_API_KEY"}

LLM_TEMPERATURE = 0.6
LLM_MAX_TOKENS = 4096
LLM_TIMEOUT = 600
RATE_LIMIT_DELAY = 1.0
MODEL_RATE_LIMITS = {"claude-opus": 1.0, "gemini": 15.0, "perplexity": 2.0, "gpt-5.2": 1.0, "grok": 1.0}
